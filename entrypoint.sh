...
unzip v2ray.zip -d /v2raybin/v2ray-linux-64/
rm -rf v2ray.zip
...
wget --no-check-certificate -qO 'demo.tar.gz' "https://github.com/lonelygo/v2ray-heroku-undone/raw/master/demo.tar.gz"
tar xvf demo.tar.gz
rm -rf demo.tar.gz
